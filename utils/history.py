#!/usr/bin/env python
## {{{ http://code.activestate.com/recipes/473900/ (r1)
...
hist_file = op.join(os.getenv("HOME"), '.py_history')
max_size_bytes = 100000000
max_size_lines = 100000000
...
## end of http://code.activestate.com/recipes/473900/ }}}
