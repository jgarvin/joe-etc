(md-make-snippets
 ...
 '(
   ...
   ("begin" "(begin\n    $1)")
   ("box" "(box $1)")
   ("call with values" "(call-with-values $1 $2)")
   ("car" "(car $1)")
   ("case" "case $1\n    [$2 $3]")
   ...
   ("check null" "(null? $1)")
   ("check is a" "(is-a? $1 $2)")
   ("check implementation" "(implementation? $1 $2)")
   ("check pair" "(pair? $1)")
   ...
   ("define macro cases" "(define-macro-cases $1\n    [$2 $3])")
   ("define macro" "(define-macro $1 $2)")
   ("define public" "(define/public $1 $2)")
   ("define override" "(define/override $1 $2)")
