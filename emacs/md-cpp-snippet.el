(md-make-snippets
 ...
 '(
   ...
   ("deckil type" "decltype($1)")
   ("deckel val" "std::declval<$1>()")
   ("deckil val" "std::declval<$1>()")
   ("delete" "delete $1;")
   ("decay" "std::decay_t<$1>")
   ("deque" "std::deque<$1>")
   ("do while" "do {\n    $1;\n} while($2);")
   ...
   ("end" "std::end($1)")
   ("E numb" "enum $1 {\n    $2,\n};")
   ("E numb class" "enum class $1 {\n    $2,\n};")
   ("enum" "enum $1 {\n    $2,\n};")
   ("enum class" "enum class $1 {\n    $2,\n};")
   ("equals" "$1 == $2")
   ("find" "std::find($1, $2, $3)")
   ...
   ("logic error" "throw std::logic_error(\"$1\");")
   ("scope" "$1::$2")
   ...
   ("log trace" "std::clog << __FILE__ << \":\" << __LINE__ << std::endl;")
   ("try" "try {\n    $1;\n} catch($2) {\n    $3;\n}")
   ("tuple" "std::tuple<$1>")
